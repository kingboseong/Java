...
//		Mandarin m2 = new Mandarin(100); /*생성자를 호출할 수 없다 - 주의점*/ 
		...
		//values()는 static 함수로 열거된 모든 원소를 배열로 리턴 ->그래서 객채가 없이 리턴.
		Mandarin m5 = Mandarin.황금향; //값을 가지고 출력을 하면 전부 출력 후 해당 값이 출력됨.- 특이점.(책에 설명 없음)
		m5.
		//for(Mandarin mnd: m4) {
		...
		System.out.println("황금향과 비교: "+ ma.compareTo(Mandarin.레드향));// compareTo도 enum클래스에 추가
