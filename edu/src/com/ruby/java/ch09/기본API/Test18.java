...
public class Test18 {
	...
	public static void main(String[] args) {
		...
		String tel_pat = "01[0-9]-\\d{3,4}-\\d{4}"; //phone number 패턴
		String email_pat = "\\w+@\\w+\\.\\w+(\\.\\w+)?"; //e-mail 패턴
        ...
        // => 비밀변호 만들때 쓰임. 쓰임새만 알아두면 됨.
        
        Pattern pattern = Pattern.compile(regex);
        Matcher matcher = pattern.matcher(password); // password2는 "암호가 유효하지 않음" 출력.
