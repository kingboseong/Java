...
//3장 객체 배열 정렬 - binary search(이진 검색)
/*
 * Comparator를 사용하는 방법 MyComparator implements Comparator<> MyComparator
 * myComparator = new MyComparator(); Arrays.sort(array, myComparator);
...
public class Test_실습3_7객체배열이진탐색 {
	...
	public static void main(String[] args) {
		...
		// 람다식은 익명클래스 + 익명 객체이다 //람다식 + comparetor 쓰는거 찾아보기 = 람다식을 보고 comparetor객체가 만들어지는구나~ 한는 연상, 이해가 필요함.
